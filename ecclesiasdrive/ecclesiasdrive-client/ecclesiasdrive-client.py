...
class subinfo(info.infoclass):
    ...
    def setDependencies(self):
        ...
        # self.runtimeDependencies["ecclesiasdrive/sparkle"] = None
...
class Package(CMakePackageBase):
    def __init__(self):
        ...
        # Pending PR to move to standard BUILD_TESTING: https://github.com/ecclesiasdrive/client/pull/6917#issuecomment-444845521
    ...
    def createPackage(self):
        ...
        self.ignoredPackages += ["libs/glib"]
    ...
    def preArchive(self):
        if isinstance(self, NullsoftInstallerPackager):
            ...
            for src, dest in [("bin",  ""), ("share/ecclesiasdrive/i18n",  "")]:
