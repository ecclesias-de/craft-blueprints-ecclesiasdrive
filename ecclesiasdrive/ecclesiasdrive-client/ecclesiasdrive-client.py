...
class subinfo(info.infoclass):
    ...
    def setTargets(self):
        self.versionInfo.setDefaultValues(
            tarballUrl="https://download.ecclesiasdrive.com/desktop/stable/ecclesiasdriveclient-${VERSION}.tar.xz",
...
class Package(CMakePackageBase):
    ...
    def applicationExecutable(self):
        return self._get_env_vars("ApplicationExecutable", "APPLICATION_EXECUTABLE", fallback="ecclesiasdrive")

    @property
    def applicationShortname(self):
        return self._get_env_vars("ApplicationShortname", "APPLICATION_SHORTNAME", fallback="ecclesiasdrive")
    ...
    def createPackage(self):
        ...
        self.defines["icon"] = self.buildDir() / "src/gui/ecclesiasdrive.ico"
